...
\title{\textbf{Predicting Online Shoppers' Purchasing Intention}}

\author{%
\IEEEauthorblockN{\textbf{Anthony Stefanuto}}
\IEEEauthorblockA{\textit{Computer Science}\\
Western University}
\and
\IEEEauthorblockN{\textbf{Hoyeon Luke Jang}}
\IEEEauthorblockA{\textit{Computer Science}\\
Western University}
\and
\IEEEauthorblockN{\textbf{Aimee Tang}}
\IEEEauthorblockA{\textit{Statistics}\\
Western University}
\and
\IEEEauthorblockN{\textbf{Nicol Elias}}
\IEEEauthorblockA{\textit{Statistics}\\
Western University}
}
...
\begin{enumerate}
    \item \textit{We conduct a comprehensive exploratory data analysis (EDA) to understand trends, correlations, and target variable relationships.}
    \item \textit{We implement and compare three machine learning models, including Logistic Regression, Decision Tree, and Random Forest, to evaluate their predictive performance.}
    \item \textit{We comprehend the key features driving purchase decisions, providing valuable insights for e-commerce platforms.}
\end{enumerate}
...
\section{\textbf{Methodology / Proposed Method}}
...
A threshold of 0.0 was used and no features were removed.
...
\subsection{\textbf{Algorithm Design}}
...
All models were trained using the same standardized protocol.
The dataset was split into 70\% training, 15\% validation (via internal cross-validation), and 15\% testing.

During training, each model learned its parameters by minimizing its respective loss function on the training set, while hyperparameters were tuned using validation performance.

After training, predictions were generated on the held-out test set, and all evaluation metrics—Accuracy, Precision, Recall, F1-score, ROC–AUC, and PR–AUC—were computed using these test predictions.

This consistent training pipeline ensures that all models are directly comparable under identical preprocessing and evaluation settings.
...
\bibitem{c1} K. Baati and M. Mohsil, “Real-time prediction of online shoppers’ purchasing intention using random forest,” in \textit{Artificial Intelligence Applications and Innovations: 16th IFIP WG 12.5 International Conference (AIAI 2020)}, Neos Marmaras, Greece, Jun. 5–7, 2020, pp. 43–51. doi: 10.1007/978-3-030-49161-1\_4.

\bibitem{c2} S. Moro, P. Rita, and P. Cortez, “A data-driven approach to predict the success of bank telemarketing,” \textit{Decision Support Systems}, vol. 62, pp. 22–31, 2016.

\bibitem{c3} F. Pedregosa \textit{et al.}, “Scikit-learn: Machine learning in Python,” \textit{Journal of Machine Learning Research}, vol. 12, pp. 2825–2830, 2011.

\bibitem{c4} D. M. W. Powers, “Evaluation: From precision, recall and F-measure to ROC, informedness, markedness and correlation,” \textit{Journal of Machine Learning Technologies}, vol. 2, no. 1, pp. 37–63, 2011.

\bibitem{c5} UCI Machine Learning Repository, “Online Shoppers Purchasing Intention Dataset,” 2018.
